...
# Read the CSV file
csv_file = r'C:\Users\mroop\OneDrive\Desktop\Charming_Data\NYC_OpenData_merged\data\NYC_housingOnly_v0.csv'

community_board_csv = r'C:\Users\mroop\OneDrive\Desktop\Charming_Data\NYC_OpenData_merged\data\NYC_Community_Boards.csv'
...
conn = sqlite3.connect('opendata_github_database.db')
cursor = conn.cursor()
